 ...
 */
package com.example.springdata.jpa.multipleds;

import com.example.springdata.jpa.multipleds.customer.Customer;
import com.example.springdata.jpa.multipleds.customer.CustomerRepository;
import com.example.springdata.jpa.multipleds.order.Order;
import com.example.springdata.jpa.multipleds.order.Order.LineItem;
import com.example.springdata.jpa.multipleds.order.OrderRepository;
...
public class DataInitializer {
	...
	public Order initializeOrder(Customer.CustomerId customer) {
