 ...
 */
package com.example.springdata.redis.commands;

import com.example.springdata.redis.test.util.RequiresRedisServer;
import com.example.springdata.redis.RedisTestConfiguration;
...
public class KeyOperationsTests {
    ...
    RequiresRedisServer requiresServer = RequiresRedisServer.onLocalhost();
