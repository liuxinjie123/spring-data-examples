 ...
 */
package com.example.springdata.redis.repositories;
...
import com.example.springdata.redis.test.util.RequiresRedisServer;
import com.example.springdata.redis.test.util.EmbeddedRedisServer;
...
public class PersonRepositoryTests<K, V> {
	...
	public void findBySingleProperty() {
		...
		assertThat(starks, Matchers.containsInAnyOrder(eddard, robb, sansa, arya, bran, rickon));
		assertThat(starks, not(Matchers.hasItem(jon)));
	}
	...
	public void findByMultipleProperties() {
		...
		assertThat(aryaStark, Matchers.hasItem(arya));
		assertThat(aryaStark, not(Matchers.hasItems(eddard, robb, sansa, bran, rickon, jon)));
	}
	...
	public void findByMultiplePropertiesUsingOr() {
		...
		assertThat(aryaAndJon, Matchers.containsInAnyOrder(arya, jon));
		assertThat(aryaAndJon, not(Matchers.hasItems(eddard, robb, sansa, bran, rickon)));
	}
	...
	public void findByEmbeddedProperty() {
		...
		assertThat(eddardStark, Matchers.hasItem(eddard));
		assertThat(eddardStark, not(Matchers.hasItems(robb, sansa, arya, bran, rickon, jon)));
	}
	...
	public void findByGeoLocationProperty() {
		...
		assertThat(eddardStark, Matchers.hasItem(robb));
		...
		assertThat(eddardAndRobbStark, Matchers.hasItems(robb, eddard));
