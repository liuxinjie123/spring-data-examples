 ...
 */
package com.example.springdata.cassandra.basic;

import static org.assertj.core.api.Assertions.*;
import static org.junit.Assume.*;

import com.example.springdata.cassandra.util.CassandraKeyspace;
import com.example.springdata.cassandra.util.CassandraVersion;
...
public class BasicUserRepositoryTests {
	...
	public void findSavedUserById() {
		...
		Assertions.assertThat(repository.findById(user.getId())).contains(user);
	}
	...
	public void findByDerivedQueryMethodWithSASI() throws InterruptedException {
		...
		Assertions.assertThat(repository.findUsersByLastnameStartsWith("last")).contains(user);
	}
}
