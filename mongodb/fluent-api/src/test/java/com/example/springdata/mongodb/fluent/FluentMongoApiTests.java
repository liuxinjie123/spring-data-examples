 ...
 */
package com.example.springdata.mongodb.fluent;
...
public class FluentMongoApiTests {
	...
	public void usePredefinedFinder() {
		Assertions.assertThat(findLuke.one()).contains(new Jedi("luke", "skywalker"));
	}
	...
	public void querySpecificCollection() {
		...
		Assertions.assertThat(skywalkers).containsExactlyInAnyOrder(new Human("anakin", "skywalker"), new Human("luke", "skywalker"));
	}
